...
def evaluate_lenet5(learning_rate=0.06, n_epochs=2000, nkerns=[44], batch_size=1, window_width=3,
    ...
    extra_train, extra_test=load_extra_features(rootPath+'train_rule_features_cosine_eucli.txt', rootPath+'test_rule_features_cosine_eucli.txt')
    ...
    layer3=LogisticRegression(rng, input=layer3_input, n_in=14+(2)+(2)+2+2, n_out=3)
